...
nothing beyond the issue. In Codex, invoke this skill as `$finn-spec`. It works
like plan mode: research the codebase,
...
issue on the configured `ZAN` Linear team (via the Linear connector) with
